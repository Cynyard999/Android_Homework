...
public class Exercises1 extends AppCompatActivity {
    ...
    private static final String TAG = "cynyard";
    private ExOneHelper helper;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        helper = (ExOneHelper)getApplication();
        setContentView(R.layout.exercise1);
        mLifecycleDisplay = findViewById(R.id.text1);
        mLifecycleDisplay.setText(helper.getValue());
    ...
    protected void onDestroy() {
        ...
        //在destroy的时候存储
        helper.setValue(mLifecycleDisplay.getText().toString());
    }
